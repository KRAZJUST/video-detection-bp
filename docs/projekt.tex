...
\projectinfo{
  ...
  title.cs={Rozpoznávání osob a jejich činnosti ve videu z bezpečnostních kamer},  % název práce v češtině či slovenštině (dle zadání) / thesis title in czech language (according to assignment)
  title.en={Recognizing People and Their Activities in Video from Security Cameras}, % název práce v angličtině / thesis title in english
  ...
  author.surname={Skalka},   % příjmení autora / author surname 
